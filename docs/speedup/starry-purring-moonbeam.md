...
- 辅助模块 + connector + vit_model 全留 GPU 0 → 图像理解/编辑路径零改动，避免 docs/DEBUG_NOTES.md §8.9 跨设备冲突复发。
...
### 1. 新建 `experiments/scripts/asym_placement.py`
...
### 3. 新建 `experiments/scripts/run_asym_bench.py`
...
5. 结果写入 `docs/EXPERIMENT_SUMMARY.md` / `docs/DEBUG_NOTES.md` 新章节。
